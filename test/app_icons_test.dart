...
void main() {
  test('app_icons assets test', () {
    ...
    expect(File(AppIcons.bathtub).existsSync(), isTrue);
    expect(File(AppIcons.bell).existsSync(), isTrue);
    expect(File(AppIcons.bellRounded).existsSync(), isTrue);
    expect(File(AppIcons.dishWasher).existsSync(), isTrue);
    expect(File(AppIcons.dripIrrigation).existsSync(), isTrue);
    ...
    expect(File(AppIcons.hoseIrrigation).existsSync(), isTrue);
    ...
    expect(File(AppIcons.irrigationControllerNonWifi).existsSync(), isTrue);
    expect(File(AppIcons.irrigationControllerWifi).existsSync(), isTrue);
    ...
    expect(File(AppIcons.poolAutoFill).existsSync(), isTrue);
    expect(File(AppIcons.poolManualFill).existsSync(), isTrue);
    ...
    expect(File(AppIcons.soakerHose).existsSync(), isTrue);
    expect(File(AppIcons.sprinklers).existsSync(), isTrue);
